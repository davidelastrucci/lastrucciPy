        ...
        if self.__dati == "ABC":
            if self.__a == 0:
                ...
                if self.__b < 0 and self.__c < 0:
                    ...
                    return f"è rivolta verso l'alto - equazione parabola:  y = {self.__a}x^2 {self.__b}x + {self.__c} "
                ...
                if self.__b < 0 and self.__c < 0:
                    return f"è rivolta verso il basso - equazione parabola:  y = {self.__a}x^2 {self.__b}x {self.__c} "
                elif self.__b < 0 and self.__c > 0:
                    return f"è rivolta verso il basso - equazione parabola:  y = {self.__a}x^2 {self.__b}x + {self.__c} "
                elif self.__c < 0 and self.__b > 0:
                    return f"è rivolta verso il basso - equazione parabola:  y = {self.__a}x^2 + {self.__b}x {self.__c} "
